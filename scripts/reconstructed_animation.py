...
# Last Modified: 2026/04/03 12:51:26
#
...
if __name__ == "__main__":
    ...
    # dir_path = '/Users/emrealca/Documents/Penn/flatiron-microtubules/simulations/data/3D_pushing_130_points_10_MTs_10_relax_time_2026-04-03_10-40-19'
    dir_path = '/Users/emrealca/Documents/Penn/flatiron-microtubules/simulations/data/3D_pushing_2562_points_100_MTs_10_relax_time_2026-04-03_12-42-53'

    spindle_from_dict = ss.restart_experiment_from_directory(dir_path, readout=True)

    print('animating')

    ani = spindle_from_dict.animate(interval=80, save=True, file_prefix='')
